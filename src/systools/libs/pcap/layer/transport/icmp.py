# -*- coding: utf-8 -*-
#
# ./libs/pcap/layer/transport/icmp.py
...
class ICMP(Layer):
  ...
  properties = [ 'type', 'code', 'checksum',
                 'id', 'seq_number', 'pktmessage', 'pktdata' ]
  ...
  def format():
    def fget(self):
      ...
      return f'id: {self.id} msg: {self.pktmessage} seq: {self.seq_number} checksum: {self.checksum} {msg}'
