...
pkthdr_p  = POINTER(POINTER(struct_pkthdr))
stat_p    = POINTER(struct_stat)
...
pcap_next_ex = CFUNCTYPE(c_int, pcap_p, pkthdr_p, POINTER(POINTER(c_ubyte * PCAP_SNAPLEN)))(
